...
const controller = require("../controller/communication.controller");

const router = express.Router();
const roles = ["SCHOOL", "VICE_ADMIN", "TEACHER", "RECEPTIONIST", "ACCOUNTANT", "LIBRARIAN"];

router.post("/messages", authMiddleware(roles), controller.sendMessage);
